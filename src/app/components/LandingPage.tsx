          ...
          <div className="max-w-2xl">
            ...
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="mb-4">
                <div className="landing-mobile-signup-stack flex flex-col sm:flex-row gap-3">
                  <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder={content.hero.emailPlaceholder} required disabled={isSubmittingTop} className="landing-mobile-signup-input flex-1 px-6 bg-white/5 backdrop-blur border border-white/20 text-white placeholder:text-white/30 focus:border-[#2FA4A9] focus:outline-none focus:ring-2 focus:ring-[#2FA4A9]/50 transition disabled:opacity-70" style={{ fontFamily: "'Inter', sans-serif", height: '64px', borderRadius: '4px', fontSize: '16px' }} />
                  <button type="submit" disabled={isSubmittingTop} className="landing-mobile-signup-button bg-[#2FA4A9] text-white font-semibold hover:bg-[#27939A] transition-all flex items-center justify-center gap-3 px-10 group disabled:opacity-70" style={{ fontFamily: "'Inter', sans-serif", height: '64px', borderRadius: '4px', boxShadow: '0 4px 20px rgba(47,164,169,0.4)' }}>{content.hero.cta}<ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" strokeWidth={2.5} /></button>
                </div>
        ...
        <div className="max-w-[800px] mx-auto px-4 sm:px-8 text-center">
          ...
          {!isSubmittedBottom ? (
            <form onSubmit={handleSubmitBottom} className="mb-4">
              <div className="landing-mobile-signup-stack flex flex-col sm:flex-row gap-3 max-w-xl mx-auto">
                <input type="email" value={emailBottom} onChange={(e) => setEmailBottom(e.target.value)} placeholder={content.hero.emailPlaceholder} required disabled={isSubmittingBottom} className="landing-mobile-signup-input flex-1 px-6 bg-white/5 backdrop-blur border border-white/20 text-white placeholder:text-white/30 focus:border-[#2FA4A9] focus:outline-none focus:ring-2 focus:ring-[#2FA4A9]/50 transition disabled:opacity-70" style={{ fontFamily: "'Inter', sans-serif", height: '64px', borderRadius: '4px', fontSize: '16px' }} />
                <button type="submit" disabled={isSubmittingBottom} className="landing-mobile-signup-button bg-[#2FA4A9] text-white font-semibold hover:bg-[#27939A] transition-all flex items-center justify-center gap-3 px-10 group disabled:opacity-70" style={{ fontFamily: "'Inter', sans-serif", height: '64px', borderRadius: '4px', boxShadow: '0 4px 20px rgba(47,164,169,0.4)' }}>{content.hero.cta}<ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" strokeWidth={2.5} /></button>
              </div>
